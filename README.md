...
\#\> Saving in R data file
\[===============================\>——————————–\]
50% / 0s Uploading R data file
\[==========================================\>———————\] 67% / 0s
Importing KUM into DIFUTURE-TEST
\[===========================================\>———\] 83% / 1s Save
completed
\[=======================================================================\]
100% / 4s \#\> Saving in R data file
\[===============================\>——————————–\] 50% / 0s Uploading R
data file \[==========================================\>———————\] 67% /
0s Importing MRI into DIFUTURE-TEST
\[===========================================\>———\] 83% / 1s Save
completed
\[=======================================================================\]
100% / 4s \#\> Saving in R data file
\[===============================\>——————————–\] 50% / 0s Uploading R
data file \[==========================================\>———————\] 67% /
0s Importing UKA into DIFUTURE-TEST
\[===========================================\>———\] 83% / 1s Save
completed
\[=======================================================================\]
100% / 4s \#\> Saving in R data file
\[===============================\>——————————–\] 50% / 0s Uploading R
data file \[==========================================\>———————\] 67% /
0s Importing UKT into DIFUTURE-TEST
\[===========================================\>———\] 83% / 1s Save
completed
\[=======================================================================\]
...
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (brierScore("D$binomial_1", "pred")) [------------------------------------]   0% / 0s  Getting aggregate ds1 (brierScore("D$binomial_1", "pred")) [====>----------------------]  20% / 0s  Checking ds2 (brierScore("D$binomial_1", "pred")) [======>-----------------------------]  20% / 0s  Getting aggregate ds2 (brierScore("D$binomial_1", "pred")) [==========>----------------]  40% / 0s  Checking ds3 (brierScore("D$binomial_1", "pred")) [=============>----------------------]  40% / 0s  Getting aggregate ds3 (brierScore("D$binomial_1", "pred")) [===============>-----------]  60% / 0s  Checking ds4 (brierScore("D$binomial_1", "pred")) [=====================>--------------]  60% / 0s  Getting aggregate ds4 (brierScore("D$binomial_1", "pred")) [=====================>-----]  80% / 1s  Aggregated (brierScore("D$binomial_1", "pred")) [======================================] 100% / 1s
brier
#> [1] 0.1733
cc = dsCalibrationCurve(conn, "D$binomial_1", "pred")
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calibrationCurve("D$binomial_1", "pred", 10, TRUE)) [--------------------]   0% / 0s  Getting aggregate ds1 (calibrationCurve("D$binomial_1", "pred", 10, TRUE)) [=>---------]  20% / 0s  Checking ds2 (calibrationCurve("D$binomial_1", "pred", 10, TRUE)) [===>----------------]  20% / 0s  Getting aggregate ds2 (calibrationCurve("D$binomial_1", "pred", 10, TRUE)) [===>-------]  40% / 0s  Checking ds3 (calibrationCurve("D$binomial_1", "pred", 10, TRUE)) [=======>------------]  40% / 0s  Getting aggregate ds3 (calibrationCurve("D$binomial_1", "pred", 10, TRUE)) [======>----]  60% / 0s  Checking ds4 (calibrationCurve("D$binomial_1", "pred", 10, TRUE)) [===========>--------]  60% / 0s  Getting aggregate ds4 (calibrationCurve("D$binomial_1", "pred", 10, TRUE)) [========>--]  80% / 1s  Aggregated (calibrationCurve("D$binomial_1", "pred", 10, TRUE)) [======================] 100% / 1s
...
#> 
#> [2021-09-21 13:45:43] Initializing ROC-GLM
#> 
#> [2021-09-21 13:45:43] Host: Received scores of negative response
#> [2021-09-21 13:45:43] Calculating standard deviation of differences
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getNegativeScoresVar("D$binomial_1", "pred", 1)) [-----------------------]   0% / 0s  Getting aggregate ds1 (getNegativeScoresVar("D$binomial_1", "pred", 1)) [==>-----------]  20% / 0s  Checking ds2 (getNegativeScoresVar("D$binomial_1", "pred", 1)) [====>------------------]  20% / 0s  Getting aggregate ds2 (getNegativeScoresVar("D$binomial_1", "pred", 1)) [=====>--------]  40% / 0s  Checking ds3 (getNegativeScoresVar("D$binomial_1", "pred", 1)) [========>--------------]  40% / 0s  Getting aggregate ds3 (getNegativeScoresVar("D$binomial_1", "pred", 1)) [=======>------]  60% / 0s  Checking ds4 (getNegativeScoresVar("D$binomial_1", "pred", 1)) [=============>---------]  60% / 1s  Getting aggregate ds4 (getNegativeScoresVar("D$binomial_1", "pred", 1)) [==========>---]  80% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (meanDS(D$binomial_1)) [--------------------------------------------------]   0% / 0s  Getting aggregate ds1 (meanDS(D$binomial_1)) [=======>---------------------------------]  20% / 0s  Checking ds2 (meanDS(D$binomial_1)) [=========>----------------------------------------]  20% / 0s  Getting aggregate ds2 (meanDS(D$binomial_1)) [===============>-------------------------]  40% / 0s  Checking ds3 (meanDS(D$binomial_1)) [===================>------------------------------]  40% / 0s  Getting aggregate ds3 (meanDS(D$binomial_1)) [========================>----------------]  60% / 1s  Checking ds4 (meanDS(D$binomial_1)) [=============================>--------------------]  60% / 1s  Getting aggregate ds4 (meanDS(D$binomial_1)) [================================>--------]  80% / 1s  Aggregated (meanDS(D$binomial_1)) [====================================================] 100% / 1s
#> [2021-09-21 13:45:45] Receiving negative scores
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getNegativeScores("D$binomial_1", "pred", 0.0545882471929637, 1)) [------]   0% / 0s  Getting aggregate ds1 (getNegativeScores("D$binomial_1", "pred", 0.0545882471929637, 1)) []  20...  Checking ds2 (getNegativeScores("D$binomial_1", "pred", 0.0545882471929637, 1)) [>-----]  20% / 0s  Getting aggregate ds2 (getNegativeScores("D$binomial_1", "pred", 0.0545882471929637, 1)) []  40...  Checking ds3 (getNegativeScores("D$binomial_1", "pred", 0.0545882471929637, 1)) [=>----]  40% / 0s  Getting aggregate ds3 (getNegativeScores("D$binomial_1", "pred", 0.0545882471929637, 1)) []  60...  Checking ds4 (getNegativeScores("D$binomial_1", "pred", 0.0545882471929637, 1)) [===>--]  60% / 1s  Getting aggregate ds4 (getNegativeScores("D$binomial_1", "pred", 0.0545882471929637, 1)) []  80...  Aggregated (...) [=====================================================================] 100% / 1s
#> [2021-09-21 13:45:46] Host: Pushing pooled scores
...
#> [2021-09-21 13:45:46] Server: Calculating placement values and parts for ROC-GLM
...
#> [2021-09-21 13:45:47] Server: Calculating probit regression to obtain ROC-GLM
...
#> [2021-09-21 13:45:48] Deviance of iter1=80.4012
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  20% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  40% / 0s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  60% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2021-09-21 13:45:49] Deviance of iter2=65.6541
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  20% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  40% / 0s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  60% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2021-09-21 13:45:49] Deviance of iter3=71.6947
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  20% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  40% / 0s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  60% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2021-09-21 13:45:50] Deviance of iter4=73.2593
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  20% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  40% / 0s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  60% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2021-09-21 13:45:51] Deviance of iter5=73.8388
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  20% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  40% / 0s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  60% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2021-09-21 13:45:51] Deviance of iter6=73.9108
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  20% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  40% / 0s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  60% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2021-09-21 13:45:52] Deviance of iter7=73.9116
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  20% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  40% / 0s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  60% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2021-09-21 13:45:53] Deviance of iter8=73.9116
#> [2021-09-21 13:45:53] Host: Finished calculating ROC-GLM
#> [2021-09-21 13:45:53] Host: Cleaning data on server
#> [2021-09-21 13:45:54] Host: Calculating AUC and CI
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (meanDS(D$binomial_1)) [--------------------------------------------------]   0% / 0s  Getting aggregate ds1 (meanDS(D$binomial_1)) [=======>---------------------------------]  20% / 0s  Checking ds2 (meanDS(D$binomial_1)) [=========>----------------------------------------]  20% / 0s  Getting aggregate ds2 (meanDS(D$binomial_1)) [===============>-------------------------]  40% / 0s  Checking ds3 (meanDS(D$binomial_1)) [===================>------------------------------]  40% / 0s  Getting aggregate ds3 (meanDS(D$binomial_1)) [========================>----------------]  60% / 1s  Checking ds4 (meanDS(D$binomial_1)) [=============================>--------------------]  60% / 1s  Getting aggregate ds4 (meanDS(D$binomial_1)) [================================>--------]  80% / 1s  Aggregated (meanDS(D$binomial_1)) [====================================================] 100% / 1s
...
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getPositiveScoresVar("D$binomial_1", "pred", 4)) [-----------------------]   0% / 1s  Getting aggregate ds1 (getPositiveScoresVar("D$binomial_1", "pred", 4)) [==>-----------]  20% / 1s  Checking ds2 (getPositiveScoresVar("D$binomial_1", "pred", 4)) [====>------------------]  20% / 1s  Getting aggregate ds2 (getPositiveScoresVar("D$binomial_1", "pred", 4)) [=====>--------]  40% / 1s  Checking ds3 (getPositiveScoresVar("D$binomial_1", "pred", 4)) [========>--------------]  40% / 1s  Getting aggregate ds3 (getPositiveScoresVar("D$binomial_1", "pred", 4)) [=======>------]  60% / 1s  Checking ds4 (getPositiveScoresVar("D$binomial_1", "pred", 4)) [=============>---------]  60% / 1s  Getting aggregate ds4 (getPositiveScoresVar("D$binomial_1", "pred", 4)) [==========>---]  80% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getNegativeScores("D$binomial_1", "pred", 0.125280303329456, 2)) [-------]   0% / 0s  Getting aggregate ds1 (getNegativeScores("D$binomial_1", "pred", 0.125280303329456, 2)) []  20%...  Checking ds2 (getNegativeScores("D$binomial_1", "pred", 0.125280303329456, 2)) [>------]  20% / 0s  Getting aggregate ds2 (getNegativeScores("D$binomial_1", "pred", 0.125280303329456, 2)) []  40%...  Checking ds3 (getNegativeScores("D$binomial_1", "pred", 0.125280303329456, 2)) [==>----]  40% / 0s  Getting aggregate ds3 (getNegativeScores("D$binomial_1", "pred", 0.125280303329456, 2)) []  60%...  Checking ds4 (getNegativeScores("D$binomial_1", "pred", 0.125280303329456, 2)) [===>---]  60% / 1s  Getting aggregate ds4 (getNegativeScores("D$binomial_1", "pred", 0.125280303329456, 2)) []  80%...  Aggregated (...) [=====================================================================] 100% / 1s
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getPositiveScores("D$binomial_1", "pred", 0.0611278761407609, 2)) [------]   0% / 0s  Getting aggregate ds1 (getPositiveScores("D$binomial_1", "pred", 0.0611278761407609, 2)) []  20...  Checking ds2 (getPositiveScores("D$binomial_1", "pred", 0.0611278761407609, 2)) [>-----]  20% / 0s  Getting aggregate ds2 (getPositiveScores("D$binomial_1", "pred", 0.0611278761407609, 2)) []  40...  Checking ds3 (getPositiveScores("D$binomial_1", "pred", 0.0611278761407609, 2)) [=>----]  40% / 0s  Getting aggregate ds3 (getPositiveScores("D$binomial_1", "pred", 0.0611278761407609, 2)) []  60...  Checking ds4 (getPositiveScores("D$binomial_1", "pred", 0.0611278761407609, 2)) [===>--]  60% / 1s  Getting aggregate ds4 (getPositiveScores("D$binomial_1", "pred", 0.0611278761407609, 2)) []  80...  Aggregated (...) [=====================================================================] 100% / 1s
#> [2021-09-21 13:45:58] Finished!
...
| AUC              |           0.8097 |      0.8121 |
| CI(0.95) (lower) |           0.7439 |      0.7599 |
| CI(0.95) (upper) |           0.8616 |      0.8551 |
